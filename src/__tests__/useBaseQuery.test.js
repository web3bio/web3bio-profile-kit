...
describe("useBaseQuery", () => {
  ...
  it("should construct the correct URL for single identity", async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      `${PROFILE_API_ENDPOINT}/${QueryEndpoint.PROFILE}/ens/vitalik.eth`,
      {
        headers: {
  ...
  it("should construct batch URL for array of identities", async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      `${PROFILE_API_ENDPOINT}/${QueryEndpoint.PROFILE}/batch/${encodeURIComponent(JSON.stringify(identities))}`,
      {
        headers: {
          "x-api-key": "default-key",
        },
  ...
  it("should use universal URL format when universal=true", async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      `${PROFILE_API_ENDPOINT}/${QueryEndpoint.PROFILE}/${identity}`,
      {
        headers: {
          "x-api-key": "default-key",
        },
