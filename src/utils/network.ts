...
export const NETWORK_DATA: { [key in Network]: NetworkType } = {
  [Network.abstract]: {
    ...
    scanPrefix: "https://abscan.org/address/",
    scanPrefixTx: "https://abscan.org/tx/",
    short: "abs",
  },
  [Network.aptos]: {
    bgColor: "#e9faf3",
  ...
  [Network.mantle]: {
    ...
    label: "Mantle",
    primaryColor: "#008f6a",
    scanLabel: "Mantle Explorer",
    scanPrefix: "https://explorer.mantle.xyz/address/",
    scanPrefixTx: "https://explorer.mantle.xyz/tx/",
    short: "mnt",
  },
  [Network.mastodon]: {
    bgColor: "#e8e8fe",
  ...
  [Network.plasma]: {
    bgColor: "#dcefea",
    chainId: 9745,
    icon: "icons/icon-plasma.svg",
    key: Network.plasma,
    label: "Plasma",
    primaryColor: "#162f29",
    scanLabel: "Plasma Explorer",
    scanPrefix: "https://plasmascan.to/address/",
    scanPrefixTx: "https://plasmascan.to/tx/",
    short: "xpl",
  },
  [Network.polygon]: {
    bgColor: "#ece5fa",
  ...
  [Network.starknet]: {
    ...
    primaryColor: "#0c0c4f",
    scanLabel: "Voyager",
    scanPrefix: "https://voyager.online/contract/",
  ...
  [Network.zero]: {
    ...
    scanPrefix: "https://explorer.zero.network/address/",
    scanPrefixTx: "https://explorer.zero.network/tx/",
    short: "zero",
  },
  [Network.zksync_era]: {
    bgColor: "#ebf0fe",
